       ...
       <KakaoAppBase>
        {
            layouts.map((layout: any, index: number) => {
                ...
                if (layout.type === "TOP")  {
                    ...
                    const webtoon_reference = references['series_card_view']["page/reference/0/24/0/F/IOS"]
                    const webnovel_reference = references['series_card_view']["page/reference/0/466/0/F/IOS"]
